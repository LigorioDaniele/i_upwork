...
class MarCal {
    ...
    isHolidayOrWeekend(market = 'nyse') {
        let time = false;
        switch (market) {
            case 'nyse':
    ...
    isEarlyTradingSession(market = 'nyse') {
        if (this.isHolidayOrWeekend(market))
            return false;
        ...
        if (ny_time >= open_time && ny_time < close_time)
            return true;
        return false;
    }
    ...
    isLateTradingSession(market = 'nyse') {
        if (this.isHolidayOrWeekend(market))
            return false;
    ...
    isCoreTradingSession(market = 'nyse') {
        if (this.isHolidayOrWeekend(market))
            return false;
...
//# sourceMappingURL=marcal.js.map